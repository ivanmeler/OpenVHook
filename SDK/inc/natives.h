...
namespace PLAYER {
	...
	static void START_PLAYER_TELEPORT( Ped ped, float x, float y, float z, float heading, BOOL p5, BOOL p6, BOOL p7 ) { invoke<Void>( 0xAD15F075A4DA0FDE, ped, x, y, z, heading, p5, p6, p7 ); } // 0xAD15F075A4DA0FDE 0xC552E06C
	...
	static void _0x11D5F725F0E780E0( Any p0, int p1 ) { invoke<Void>( 0x11D5F725F0E780E0, p0, p1 ); } // 0x11D5F725F0E780E0 0x725C6174
	...
	static void _0x977DB4641F6FC3DB( Any p0, Hash model ) { invoke<Void>( 0x977DB4641F6FC3DB, p0, model ); } // 0x977DB4641F6FC3DB 0x5D382498
...
namespace ENTITY {
	...
	static Vector3 GET_ENTITY_SPEED_VECTOR( Entity entity, BOOL p1 ) { return invoke<Vector3>( 0x9A8D700A51CB7B0D, entity, p1 ); } // 0x9A8D700A51CB7B0D 0x3ED2B997
...
namespace PED {
	...
	static BOOL IS_PED_IN_COMBAT( Ped ped, BOOL p1 ) { return invoke<BOOL>( 0x4859F1FC66A6278E, ped, p1 ); } // 0x4859F1FC66A6278E 0xFE027CB5
	...
	static BOOL IS_PED_EVASIVE_DIVING( Ped ped, Vehicle* returnedVehicle ) { return invoke<BOOL>( 0x414641C26E105898, ped, returnedVehicle ); } // 0x414641C26E105898 0xD82829DC
...
namespace VEHICLE {
	...
	static void SET_SCRIPT_VEHICLE_GENERATOR( Any vehicleGenerator, Any p1 ) { invoke<Void>( 0xD9D620E0AC6DC4B0, vehicleGenerator, p1 ); } // 0xD9D620E0AC6DC4B0 0x40D73747
	...
	static void SET_PED_TARGETTABLE_VEHICLE_DESTROY( Vehicle vehicle, int vehicleComponent, int destoryType ) { invoke<Void>( 0xBE70724027F85BCD, vehicle, vehicleComponent, destoryType ); } // 0xBE70724027F85BCD 0xD61D182D
	...
	static void SET_VEHICLE_DOORS_LOCKED_FOR_PLAYER( Vehicle vehicle, int door, BOOL toggle ) { invoke<Void>( 0x517AAF684BB50CD1, vehicle, door, toggle ); } // 0x517AAF684BB50CD1 0x49829236
	static BOOL GET_VEHICLE_DOORS_LOCKED_FOR_PLAYER( Vehicle vehicle, int door ) { return invoke<BOOL>( 0xF6AF6CB341349015, vehicle, door ); } // 0xF6AF6CB341349015 0x1DC50247
	...
	static void SET_VEHICLE_DOORS_LOCKED_FOR_TEAM( Vehicle vehicle, int door, BOOL toggle ) { invoke<Void>( 0xB81F6D4A8F5EEBA8, vehicle, door, toggle ); } // 0xB81F6D4A8F5EEBA8 0x4F85E783
	...
	static BOOL GET_VEHICLE_LIGHTS_STATE( Vehicle vehicle, Any* p1, Any* p2 ) { return invoke<BOOL>( 0xB91B4C20085BD12F, vehicle, p1, p2 ); } // 0xB91B4C20085BD12F 0x7C278621
	...
	static Vehicle GET_RANDOM_VEHICLE_IN_SPHERE( float p0, float p1, float p2, float p3, int p4, int p5 ) { return invoke<Vehicle>( 0x386F6CE5BAF6091C, p0, p1, p2, p3, p4, p5 ); } // 0x386F6CE5BAF6091C 0x57216D03
	...
	static void START_VEHICLE_HORN( Vehicle vehicle, int durationInMilli, Hash action, BOOL p3 ) { invoke<Void>( 0x9C8C6504B5B63D2C, vehicle, durationInMilli, action, p3 ); } // 0x9C8C6504B5B63D2C 0x0DF5ADB3
	...
	static BOOL _SET_VEHICLE_OWNER( Vehicle vehicle, Ped owner ) { return invoke<BOOL>( 0x8F5EBAB1F260CFCE, vehicle, owner ); } // 0x8F5EBAB1F260CFCE 0x4A557117
	...
	static float _GET_VEHICLE_HEALTH( Vehicle vehicle ) { return invoke<float>( 0xF271147EB7B40F12, vehicle ); } // 0xF271147EB7B40F12 0x2B2FCC28
	static void _SET_VEHICLE_HEALTH( Vehicle vehicle, float health ) { invoke<Void>( 0xB77D05AC8C78AADB, vehicle, health ); } // 0xB77D05AC8C78AADB 0x920C2517
...
namespace OBJECT {
	static Object CREATE_OBJECT( Hash modelHash, float x, float y, float z, BOOL p4, BOOL p5, BOOL dynamic ) { return invoke<Object>( 0x509D5878EB39E842, modelHash, x, y, z, p4, p5, dynamic ); } // 0x509D5878EB39E842 0x2F7AA05C
...
namespace AI {
	...
	static void TASK_VEHICLE_PARK( Ped ped, Vehicle vehicle, float x, float y, float z, float heading, Any p6, float p7, BOOL p8 ) { invoke<Void>( 0x0F3E34E968EA374E, ped, vehicle, x, y, z, heading, p6, p7, p8 ); } // 0x0F3E34E968EA374E 0x5C85FF90
	...
	static void TASK_PLAY_ANIM( Ped ped, char* animDictionary, char* animationName, float speed, float speedMultiplier, int duration, int lastAnimation, float playbackRate, BOOL lockX, BOOL lockY, BOOL lockZ ) { invoke<Void>( 0xEA47FE3719165B94, ped, animDictionary, animationName, speed, speedMultiplier, duration, lastAnimation, playbackRate, lockX, lockY, lockZ ); } // 0xEA47FE3719165B94 0x5AB552C6
	...
	static void TASK_VEHICLE_PLAY_ANIM( Vehicle vehicle, char* unknown, char* unknown2 ) { invoke<Void>( 0x69F5C3BD0F3EBD89, vehicle, unknown, unknown2 ); } // 0x69F5C3BD0F3EBD89 0x2B28F598
	...
	static void TASK_COMBAT_PED( Ped ped, Ped targetPed, Any p2, Any p3 ) { invoke<Void>( 0xF166E48407BAC484, ped, targetPed, p2, p3 ); } // 0xF166E48407BAC484 0xCB0D8932
...
namespace GAMEPLAY {
	...
	static void SHOOT_SINGLE_BULLET_BETWEEN_COORDS( float x1, float y1, float z1, float x2, float y2, float z2, int damage, BOOL p7, Hash weaponHash, Ped ownerPed, BOOL p10, BOOL p11, float speed ) { invoke<Void>( 0x867654CBC7606F2C, x1, y1, z1, x2, y2, z2, damage, p7, weaponHash, ownerPed, p10, p11, speed ); } // 0x867654CBC7606F2C 0xCB7415AC
	...
	static BOOL STRING_TO_INT( char* string, int* integerStore ) { return invoke<BOOL>( 0x5A5F40FE637EB584, string, integerStore ); } // 0x5A5F40FE637EB584 0x590A8160
	...
	static void _START_SAVE_STRUCT( Any* p0, Any p1, Any* p2 ) { invoke<Void>( 0xBF737600CDDBEADD, p0, p1, p2 ); } // 0xBF737600CDDBEADD 0xFB45728E
	static void STOP_SAVE_STRUCT() { invoke<Void>( 0xEB1774DF12BB9F12 ); } // 0xEB1774DF12BB9F12 0xC2624A28
	static void _START_SAVE_ARRAY( Any* p0, Any p1, char* arrayName ) { invoke<Void>( 0x60FE567DF1B1AF9D, p0, p1, arrayName ); } // 0x60FE567DF1B1AF9D 0x893A342C
...
namespace WEAPON {
	...
	static Any GET_WEAPONTYPE_MODEL( Hash* weaponType ) { return invoke<Any>( 0xF46CDC33180FDA94, weaponType ); } // 0xF46CDC33180FDA94 0x44E1C269
	...
	static void GIVE_WEAPON_TO_PED( Ped ped, Hash weaponHash, int ammoCount, BOOL equipNow, BOOL isAmmoLoaded ) { invoke<Void>( 0xBF0FD6E56C964FCB, ped, weaponHash, ammoCount, equipNow, isAmmoLoaded ); } // 0xBF0FD6E56C964FCB 0xC4D88A85
	...
	static Any GET_MAX_AMMO_IN_CLIP( Ped ped, Hash weaponHash, BOOL p2 ) { return invoke<Any>( 0xA38DCFFCEA8962FA, ped, weaponHash, p2 ); } // 0xA38DCFFCEA8962FA 0x6961E2A4
	static BOOL GET_AMMO_IN_CLIP( Ped ped, Hash weaponHash, Any* p2 ) { return invoke<BOOL>( 0x2E1202248937775C, ped, weaponHash, p2 ); } // 0x2E1202248937775C 0x73C100C3
	...
	static Any GET_PED_LAST_WEAPON_IMPACT_COORD( Ped ped, float* coords ) { return invoke<Any>( 0x6C4D0409BA1A2BC2, ped, coords ); } // 0x6C4D0409BA1A2BC2 0x9B266079
	...
	static Any GET_SELECTED_PED_WEAPON( Ped ped ) { return invoke<Any>( 0x0A6DB4965674D243, ped ); } // 0x0A6DB4965674D243 0xD240123E
...
namespace STREAMING {
	...
	static BOOL HAS_ANIM_DICT_LOADED( char* AnimSet ) { return invoke<BOOL>( 0xD031A9162D01088C, AnimSet ); } // 0xD031A9162D01088C 0x05E6763C
...
namespace UI {
	...
	static int _0x1CCD9A37359072CF( char* p0, char* p1, BOOL p2, int p3, char* p4, char* p5 ) { return invoke<int>( 0x1CCD9A37359072CF, p0, p1, p2, p3, p4, p5 ); } // 0x1CCD9A37359072CF 0xE7E3C98B
...
namespace GRAPHICS {
	...
	static void _DRAW_3D_BOX( float x1, float y1, float z1, float x2, float y2, float z2, int r, int g, int b, int alpha ) { invoke<Void>( 0xD3A9971CADAC7252, x1, y1, z1, x2, y2, z2, r, g, b, alpha ); } // 0xD3A9971CADAC7252 0xCD4D9DD5
	...
	static BOOL START_PARTICLE_FX_NON_LOOPED_AT_COORD( char* effectName, float x, float y, float z, float p4, float p5, float p6, Hash p7, BOOL p8, BOOL p9, BOOL p10 ) { return invoke<BOOL>( 0x25129531F77B9ED3, effectName, x, y, z, p4, p5, p6, p7, p8, p9, p10 ); } // 0x25129531F77B9ED3 0xDD79D679
	static Any START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE( char* effectName, Ped ped, float x, float y, float z, float p5, float p6, float p7, Hash pedBone, float p9, BOOL p10, BOOL p11, BOOL p12 ) { return invoke<Any>( 0x0E7E72961BA18619, effectName, ped, x, y, z, p5, p6, p7, pedBone, p9, p10, p11, p12 ); } // 0x0E7E72961BA18619 0x53DAEF4E
	...
	static BOOL START_PARTICLE_FX_NON_LOOPED_ON_ENTITY( char* p0, Any p1, float p2, float p3, float p4, float p5, float p6, float p7, float p8, BOOL p9, BOOL p10, BOOL p11 ) { return invoke<BOOL>( 0x0D53A3B8DA0809D2, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11 ); } // 0x0D53A3B8DA0809D2 0x9604DAD4
	...
	static Any START_PARTICLE_FX_LOOPED_AT_COORD( char* effectName, float x, float y, float z, float xRot, float yRot, float zRot, float size, BOOL p8, BOOL p9, BOOL p10, BOOL p11 ) { return invoke<Any>( 0xE184F4F0DC5910E7, effectName, x, y, z, xRot, yRot, zRot, size, p8, p9, p10, p11 ); } // 0xE184F4F0DC5910E7 0xD348E3E6
...
namespace DATAFILE {
	...
	static BOOL _0x692D808C34A82143( Any* p0, float p1, char* p2 ) { return invoke<BOOL>( 0x692D808C34A82143, p0, p1, p2 ); } // 0x692D808C34A82143 0xBB6321BD
	...
	static float FOCUS_USE_SPLINE( Any* arrayData, int arrayIndex ) { return invoke<float>( 0xC0C527B525D7CFB5, arrayData, arrayIndex ); } // 0xC0C527B525D7CFB5 0x08AD2CC2
	static char* OVERIDE_TEXTURENAMES( Any* arrayData, int arrayIndex ) { return invoke<char*>( 0xD3F2FFEB8D836F52, arrayData, arrayIndex ); } // 0xD3F2FFEB8D836F52 0x93F985A6
...
namespace FIRE {
	...
	static void ADD_EXPLOSION( float x, float y, float z, int explosionType, float explosionRadius, BOOL isAudible, BOOL isInvisible, float cameraShake ) { invoke<Void>( 0xE3AD2BDBAEE269AC, x, y, z, explosionType, explosionRadius, isAudible, isInvisible, cameraShake ); } // 0xE3AD2BDBAEE269AC 0x10AF5258
	static void ADD_OWNED_EXPLOSION( Ped ped, float x, float y, float z, int explosionType, float explosionRadius, BOOL isAudible, BOOL isInvisible, float cameraShake ) { invoke<Void>( 0x172AA1B624FA1013, ped, x, y, z, explosionType, explosionRadius, isAudible, isInvisible, cameraShake ); } // 0x172AA1B624FA1013 0x27EE0D67
	static void _ADD_SPECFX_EXPLOSION( float x, float y, float z, int explosionType, Hash explosionFx, float radius, BOOL isAudible, BOOL isInvisible, float cameraShake ) { invoke<Void>( 0x36DD3FE58B5E5212, x, y, z, explosionType, explosionFx, radius, isAudible, isInvisible, cameraShake ); } // 0x36DD3FE58B5E5212 0xCF358946
...
namespace WORLDPROBE {
	static Any _0x7EE9F5D83DD4F90E( float x1, float y1, float z1, float x2, float y2, float z2, int flags, Entity entity, int p8 ) { return invoke<Any>( 0x7EE9F5D83DD4F90E, x1, y1, z1, x2, y2, z2, flags, entity, p8 ); } // 0x7EE9F5D83DD4F90E 0xEFAF4BA6
	static Any _CAST_RAY_POINT_TO_POINT( float x1, float y1, float z1, float x2, float y2, float z2, int flags, Entity entity, Any p8 ) { return invoke<Any>( 0x377906D8A31E5586, x1, y1, z1, x2, y2, z2, flags, entity, p8 ); } // 0x377906D8A31E5586 0x8251485D
	...
	static int _GET_RAYCAST_RESULT( Any RayHandle, int* hit, Vector3* endCoords, Vector3* p3, Object* objHit ) { return invoke<int>( 0x3D87450E15D98694, RayHandle, hit, endCoords, p3, objHit ); } // 0x3D87450E15D98694 0xF3C2875A
...
namespace NETWORK {
	...
	static void NETWORK_HANDLE_FROM_PLAYER( Player player, int* FreeMemPointer, int p2 ) { invoke<Void>( 0x388EB2B86C73B6B3, player, FreeMemPointer, p2 ); } // 0x388EB2B86C73B6B3 0xD3498917
	...
	static BOOL NETWORK_IS_HANDLE_VALID( int* FreeMemPointer, int p1 ) { return invoke<BOOL>( 0x6F79B93B0A8E4133, FreeMemPointer, p1 ); } // 0x6F79B93B0A8E4133 0xF0996C6E
	...
	static BOOL NETWORK_IS_FRIEND( int* FreeMemPointer ) { return invoke<BOOL>( 0x1A24A179F9B31654, FreeMemPointer ); } // 0x1A24A179F9B31654 0x2DA4C282
	...
	static Any NETWORK_EXPLODE_VEHICLE( Vehicle vehicleID, BOOL p1, BOOL p2, BOOL p3 ) { return invoke<Any>( 0x301A42153C9AD707, vehicleID, p1, p2, p3 ); } // 0x301A42153C9AD707 0x0E1B38AE
...
namespace DLC1 {
	...
	static int _0x9BDF59818B1E38C1( int p0, int p1, int p2, int p3, int p4, int p5 ) { return invoke<int>( 0x9BDF59818B1E38C1, p0, p1, p2, p3, p4, p5 ); } // 0x9BDF59818B1E38C1 0x594E862C
	...
	static int _0xF3FBE2D50A6A8C28( int p0, BOOL p1 ) { return invoke<int>( 0xF3FBE2D50A6A8C28, p0, p1 ); } // 0xF3FBE2D50A6A8C28 0x1ECD23E7
...
namespace DECORATOR {
	static BOOL _0x95AED7B8E39ECAA4( Entity entity, char* propertyName, Any value ) { return invoke<BOOL>( 0x95AED7B8E39ECAA4, entity, propertyName, value ); } // 0x95AED7B8E39ECAA4 0xBBAEEF94
