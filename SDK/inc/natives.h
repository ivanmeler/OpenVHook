...
namespace PLAYER
{
	...
	static Player GET_ENTITY_PLAYER_IS_FREE_AIMING_AT(Player player, Entity* entity) { return invoke<Player>(0x2975C866E6713290, player, entity); } // 0x2975C866E6713290 0x8866D9D0
...
namespace ENTITY
{
	...
	static void ATTACH_ENTITY_TO_ENTITY(Entity entity1, Entity entity2, int boneIndex, float xPos, float yPos, float zPos, float xRot, float yRot, float zRot, BOOL p9, BOOL useSoftPinning, BOOL collision, BOOL p12, int vertexIndex, BOOL fixedRot) { invoke<Void>(0x6B9BBD38AB0796DF, entity1, entity2, boneIndex, xPos, yPos, zPos, xRot, yRot, zRot, p9, useSoftPinning, collision, p12, vertexIndex, fixedRot); } // 0x6B9BBD38AB0796DF 0xEC024237
...
namespace PED
{
	...
	static Any SET_EXCLUSIVE_PHONE_RELATIONSHIPS(Ped p0) { return invoke<Any>(0xF92691AED837A5FC, p0); } // 0xF92691AED837A5FC 0x56E0C163
	...
	static void SET_SYNCHRONIZED_SCENE_LOOPED(int sceneID, BOOL loopedState) { invoke<Void>(0xD9A897A4C6C2974F, sceneID, loopedState); } // 0xD9A897A4C6C2974F 0x32ED9F82
...
namespace VEHICLE
{
	...
	static BOOL IS_VEHICLE_MODEL(Vehicle vehicle, Vehicle hash) { return invoke<BOOL>(0x423E8DE37D934D89, vehicle, hash); } // 0x423E8DE37D934D89 0x013B10B6
	...
	static void _CLOSE_VEHICLE_BOMB_BAY(Vehicle vehicle) { invoke<Void>(0x3556041742A0DC74, vehicle); } // 0x3556041742A0DC74 0xF8EC5751
	...
	static Vehicle _0xB2D06FAEDE65B577() { return invoke<Vehicle>(0xB2D06FAEDE65B577); } // 0xB2D06FAEDE65B577 0xFEB0C0C8
...
namespace OBJECT
{
	...
	static BOOL _0x46494A2475701343(float p0, float p1, float p2, float p3, int modelHash, BOOL p5) { return invoke<BOOL>(0x46494A2475701343, p0, p1, p2, p3, modelHash, p5); } // 0x46494A2475701343 0x7DB578DD
	...
	static void _0x3430676B11CDF21D(float x, float y, float z, int colorIndex) { invoke<Void>(0x3430676B11CDF21D, x, y, z, colorIndex); } // 0x3430676B11CDF21D 0x63B02FAD
...
namespace AI
{
	...
	static void TASK_SMART_FLEE_COORD(Any ped, float x, float y, float z, float distance, int time, BOOL p6, BOOL p7) { invoke<Void>(0x94587F17E9C365D5, ped, x, y, z, distance, time, p6, p7); } // 0x94587F17E9C365D5 0xB2E686FC
	...
	static void TASK_SYNCHRONIZED_SCENE(Ped ped, int scene, char* animDictionary, char* animationName, float p4, float p5, Any p6, Any p7, float p8, Any p9) { invoke<Void>(0xEEA929141F699854, ped, scene, animDictionary, animationName, p4, p5, p6, p7, p8, p9); } // 0xEEA929141F699854 0x4F217E7B
...
namespace GAMEPLAY
{
	...
	static void _CLEAR_AREA_2(float x, float y, float z, float radius, BOOL p4, BOOL p5, BOOL p6, BOOL p7) { invoke<Void>(0x957838AAF91BD12D, x, y, z, radius, p4, p5, p6, p7); } // 0x957838AAF91BD12D 0x20E4FFD9
	...
	static BOOL _0x557E43C447E700A8(Hash hash) { return invoke<BOOL>(0x557E43C447E700A8, hash); } // 0x557E43C447E700A8
...
namespace CAM
{
	...
	static void ATTACH_CAM_TO_ENTITY(Cam cam, Entity entity, float xOffset, float yOffset, float zOffset, BOOL p5) { invoke<Void>(0xFEDB7D269E8C60E3, cam, entity, xOffset, yOffset, zOffset, p5); } // 0xFEDB7D269E8C60E3 0xAD7C45F6
...
namespace SCRIPT
{
	...
	static void TRIGGER_SCRIPT_EVENT(int p0, int* argsStruct, int argsStructSize, int bitset) { invoke<Void>(0x5AE99C571D5BBE5D, p0, argsStruct, argsStructSize, bitset); } // 0x5AE99C571D5BBE5D 0x54763B35
...
namespace UI
{
	...
	static BOOL HAS_ADDITIONAL_TEXT_LOADED(int p0) { return invoke<BOOL>(0x02245FE4BED318B8, p0); } // 0x02245FE4BED318B8 0xB0E56045
	...
	static void _SET_MAP_VISIBLE(BOOL toggle) { invoke<Void>(0x9133955F1A2DA957, toggle); } // 0x9133955F1A2DA957 0x02F5F1D1
...
namespace GRAPHICS
{
	...
	static void GET_SCREEN_RESOLUTION(float* x, float* y) { invoke<Void>(0x888D57E407E63624, x, y); } // 0x888D57E407E63624 0x29F3572F
	...
	static int START_PARTICLE_FX_LOOPED_AT_COORD(char* effectName, float x, float y, float z, float xRot, float yRot, float zRot, float scale, BOOL p8, BOOL p9, BOOL p10, BOOL p11) { return invoke<int>(0xE184F4F0DC5910E7, effectName, x, y, z, xRot, yRot, zRot, scale, p8, p9, p10, p11); } // 0xE184F4F0DC5910E7 0xD348E3E6
...
namespace PATHFIND
{
	...
	static BOOL GET_VEHICLE_NODE_PROPERTIES(float x, float y, float z, Any* unknown1, int* flags) { return invoke<BOOL>(0x0568566ACBB5DEDC, x, y, z, unknown1, flags); } // 0x0568566ACBB5DEDC 0xCC90110B
...
namespace CONTROLS
{
	...
	static void _0x8290252FFF36ACB5(int p0, int colorR, int colorG, int colorB) { invoke<Void>(0x8290252FFF36ACB5, p0, colorR, colorG, colorB); } // 0x8290252FFF36ACB5
...
namespace WATER
{
	...
	static float _GET_WAVES_HEIGHT() { return invoke<float>(0x2B2A2CC86778B619); } // 0x2B2A2CC86778B619
	static void _RESET_WAVES_HEIGHT() { invoke<Void>(0x5E5E99285AE812DB); } // 0x5E5E99285AE812DB
}
...
namespace NETWORK
{
	...
	static void NETWORK_FADE_OUT_ENTITY(Entity entity, BOOL nomal, BOOL slow) { invoke<Void>(0xDE564951F95E09ED, entity, nomal, slow); } // 0xDE564951F95E09ED 0x47EDEE56
	...
	static int _0x02C40BF885C567B6(int netScene) { return invoke<int>(0x02C40BF885C567B6, netScene); } // 0x02C40BF885C567B6 0x16AED87B
...
namespace SOCIALCLUB
{
	...
	static float _0xFFE5C16F402D851D(Any p0, char* p1) { return invoke<float>(0xFFE5C16F402D851D, p0, p1); } // 0xFFE5C16F402D851D
