...
namespace PLAYER
{
	...
	static BOOL GET_NUMBER_OF_PLAYERS() { return invoke<BOOL>(0x407C7F91DDB46C16); } // 0x407C7F91DDB46C16 0x4C1B8867
	...
	static BOOL GET_WANTED_LEVEL_RADIUS(BOOL player) { return invoke<BOOL>(0x085DEB493BE80812, player); } // 0x085DEB493BE80812 0x1CF7D7DA
	...
	static void SET_ALL_RANDOM_PEDS_FLEE(Player* player, Any toggle) { invoke<Void>(0x056E0FE8534C2949, player, toggle); } // 0x056E0FE8534C2949 0x49EAE968
	...
	static int INT_TO_PARTICIPANTINDEX(Player value) { return invoke<int>(0x9EC6603812C24710, value); } // 0x9EC6603812C24710 0x98F3B274
	...
	static void _0x5702B917B99DB1CD(ScrHandle* p0) { invoke<Void>(0x5702B917B99DB1CD, p0); } // 0x5702B917B99DB1CD
	...
	static void SET_PLAYER_HAS_RESERVE_PARACHUTE(Vehicle player) { invoke<Void>(0x7DDAB28D31FAC363, player); } // 0x7DDAB28D31FAC363 0xA3E4798E
	...
	static BOOL _0x65FAEE425DE637B0(Player player) { return invoke<BOOL>(0x65FAEE425DE637B0, player); } // 0x65FAEE425DE637B0
	static void _0x5501B7A5CDB79D37(Player player) { invoke<Void>(0x5501B7A5CDB79D37, player); } // 0x5501B7A5CDB79D37
	static Any* _0x56105E599CAB0EFA(Hash p7) { return invoke<Any*>(0x56105E599CAB0EFA, p7); } // 0x56105E599CAB0EFA
}
...
namespace PED
{
	...
	static Ped CREATE_RANDOM_PED_AS_DRIVER(Vehicle banshee, BOOL returnHandle) { return invoke<Ped>(0x9B62392B474F44A0, banshee, returnHandle); } // 0x9B62392B474F44A0 0xB927CE9A
	...
	static int GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(Ped mp_f_freemode_01, int Te, int DrawableID) { return invoke<int>(0x8F7156A3142A6BAD, mp_f_freemode_01, Te, DrawableID); } // 0x8F7156A3142A6BAD 0x83D9FBE7
...
namespace OBJECT
{
	...
	static float CREATE_OBJECT_NO_OFFSET(int* modelfwgaHash, float x, float y, float z, BOOL isNetwork, BOOL thisScriptCheck, BOOL dynamic) { return invoke<float>(0x9A294B2138ABB884, modelfwgaHash, x, y, z, isNetwork, thisScriptCheck, dynamic); } // 0x9A294B2138ABB884 0x58040420
...
namespace AUDIO
{
	...
	static void _0xEE066C7006C49C0A(Entity entity, int unk, char* speech) { invoke<Void>(0xEE066C7006C49C0A, entity, unk, speech); } // 0xEE066C7006C49C0A 0x498849F3
...
namespace WEAPON
{
	...
	static Entity _0xB4C8D77C80C0421E(Ped ped, BOOL p1) { return invoke<Entity>(0xB4C8D77C80C0421E, ped, p1); } // 0xB4C8D77C80C0421E 0xEC2E5304
...
namespace NETWORK
{
	...
	static BOOL _0x74698374C45701D2() { return invoke<BOOL>(0x74698374C45701D2); } // 0x74698374C45701D2 0x70ED476A
	...
	static void _NETWORK_REMOVE_STICKYBOMB(Entity entity) { invoke<Void>(0x715135F4B82AC90D, entity); } // 0x715135F4B82AC90D 0xCEAE5AFC
